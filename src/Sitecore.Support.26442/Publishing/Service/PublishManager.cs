namespace Sitecore.Support.Publishing.Service
{
  ...
  using Sitecore.Framework.Publishing.Data.Model;
  ...
  public class PublishManager : DefaultPublishManager
  {
    ...
    public override Handle Publish(Sitecore.Publishing.PublishOptions[] options, Language clientLanguage)
    {
      var builtOptions = options.Select(x =>
      {
        ...
        var publishType = rootId.HasValue ? PublishingJobType.SingleItem : PublishingJobType.Incremental;
    ...
    protected virtual Handle EnqueuePublishJob(
      ...
      PublishingJobType publishType,
      Sitecore.Data.Items.Item startItem = null)
    {
      var publishStatus = new PublishStatus();
      ...
      var itemId = ItemIDs.RootID.Guid;
          ...
          (
              ...
              (
                  ...
                  (
                      ...
                      item.Version.Number,
                      finalRevision,
                      _sitecoreSettings.DefaultSourceDatabaseName
                  ),
                  itemPath,
                  operation
              )
    ...
    private ItemOperationRestrictions GetRestrictions(Sitecore.Data.Items.Item item)
    {
      return new ItemOperationRestrictions
      {
        PublishDate = item.Publishing.PublishDate,
        UnpublishDate = item.Publishing.UnpublishDate,
        ValidFrom = item.Publishing.ValidFrom,
        ValidTo = item.Publishing.ValidTo
      };
    }
